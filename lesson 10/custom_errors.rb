...
class PresenceValidate < ValidationError
  def initialize(msg = 'The value cannot be empty')
    super
  end
end

class FormatValidate < ValidationError
  def initialize(msg = 'Incorrect value format')
    super
  end
end

class TypeValidate < ValidationError
  def initialize(msg = 'Incorrect value type')
    super
  end
end
